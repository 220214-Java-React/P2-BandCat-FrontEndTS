  ...
  async function search() {
    ...
    switch (searchCriteria) {
      ...
      case 0:
        if (usernameToSearch) {
          // axios for username
          let foundUser = await baseURL
            .get("/users/byUsername/" + usernameToSearch)
            .then((response) => response.data)
            .catch(() => {
              alert(
                "Something went wrong while Searching by Username. Try again"
              );
              return;
            });
      ...
      case 1:
        ...
        let foundUsers = await baseURL
          .post("/instruments/findUsers", JSON.stringify(instrumentToSearch), {
            headers: {
          ...
          .catch(() => {
            alert(
              "Something went wrong while Searching by Instrument. Try again"
            );
            return;
          });
        ...
        <div className="searchBackgroundColor">
          ...
          <div className="searchBox">
            <div className="bodyText">
              <form style={{ margin: "10px 0px" }}>
                ...
                {searchCriteria == 0 ? (
                  ...
                  <ByInstrument
                    instrumentToSearch={instrumentToSearch}
                    setInstrumentToSearch={setInstrumentToSearch}
                  />
                )}
            ...
            {/* <img
              ...
              src={require("../../pics/instrumentLogo.png")}
            ></img> */}
          </div>

          <img
            className="bottomCorner"
            src={require("../../pics/bottomCorner.png")}
          ></img>
        </div>
      </>
    );
