...
export default function SignUp()
{
    ...
    async function sendInfo()
    {
        ...
        let userReturned = await axios.post('http://localhost:8080/users',
        ...
        await axios.post('http://localhost:8080/instruments/' + instrumentForUser.instrumentID,
    ...
    <>
        <form>
            ...
            <input type="password" placeholder="Password" name="password" value={password} onChange={changePassword}/>
            <br />
            ...
            <input type="text" placeholder="Phone Number" name="phoneNumber" value={phoneNumber} onChange={changePhoneNumber}/>
            <br />
            ...
            <label>
                ...
                <select id='instrument_name' value={instrument} onChange={changeInstrument}>
            ...
            <button type="button" onClick={sendInfo}>Register</button>
            
            {/* Example of how to link other "pages" via a button click*/}
            <Link to="/login"><button type="button">Hi</button></Link>
        </form>
    </>);
}